...
export default function HomePage({ setPage }) {
  ...
  return (
    <div>
      <div className="bg-gradient-to-br from-teal-50 via-cyan-50 to-emerald-50 pt-24 pb-8 px-8 min-h-screen flex flex-col justify-between relative overflow-hidden">
        {/* Decorative circles */}
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-1">
              ...
              <div className="flex gap-4 mt-6">
                <a
                  href="https://www.facebook.com/nlisted"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-700 hover:bg-emerald-500 rounded-full flex items-center justify-center transition-all duration-300"
                >
                ...
                <a
                  href="https://twitter.com/nlisted"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-700 hover:bg-emerald-500 rounded-full flex items-center justify-center transition-all duration-300"
                >
                ...
                <a
                  href="https://www.linkedin.com/company/nlisted"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-700 hover:bg-emerald-500 rounded-full flex items-center justify-center transition-all duration-300"
                >
                ...
                <a
                  href="https://www.instagram.com/nlisted"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-gray-700 hover:bg-emerald-500 rounded-full flex items-center justify-center transition-all duration-300"
                >
