          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-1">
              ...
              <div className="flex gap-4 mt-6">
                <a href="#" className="w-10 h-10 bg-gray-700 hover:bg-emerald-500 rounded-full flex items-center justify-center transition-all duration-300">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" onClick={() => setPage('home')} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">Home</a>
                </li>
                <li>
                  <a href="#" onClick={() => setPage('buy')} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">Buy Shares</a>
                </li>
                <li>
                  <a href="#" onClick={() => setPage('sell')} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">Sell Shares</a>
                </li>
                <li>
                  <a href="#" onClick={() => setPage('marketplace')} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">Marketplace</a>
                </li>
                <li>
                  <a href="#" onClick={() => setPage('about')} className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">About Us</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">How It Works</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">FAQs</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">Blog</a>
                </li>
                <li>
                  <a href="#" className="text-gray-400 hover:text-emerald-400 transition-colors duration-300 text-sm">Terms & Conditions</a>
                </li>
                <li>
