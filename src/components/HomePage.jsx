...
export default function HomePage({ setPage }) {
  ...
  return (
    <div>
      <div className="bg-gradient-to-br from-teal-50 via-cyan-50 to-emerald-50 pt-24 pb-8 px-8 h-screen flex flex-col justify-between relative overflow-hidden">
        {/* Decorative circles */}
