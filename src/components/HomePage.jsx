...
export default function HomePage({ setPage }) {
  ...
  return (
    <div>
      <div className="bg-gradient-to-br from-teal-50 via-cyan-50 to-emerald-50 pt-8 pb-8 px-8 min-h-screen flex flex-col justify-between relative overflow-hidden">
        {/* Decorative circles */}
      ...
      <div className="bg-gray-50 py-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {/* Scrolling Company Cards with Logos */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-16">
            <button 
              ...
              className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-10 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
            >
              Learn More
            </button>
          </div>
      ...
      {/* Footer Section */}
      <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16 border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            {/* Company Info */}
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-emerald-400">Nlist Planet</h3>
              <p className="text-gray-400 text-sm">
                India's trusted platform for buying and selling unlisted shares. Own a stake in the fastest-growing companies.
              </p>
              <div className="flex gap-4 pt-2">
                <button type="button" className="text-gray-400 hover:text-emerald-400 transition-colors bg-transparent border-0 p-0 cursor-pointer">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li><a href="/how-it-works" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">How It Works</a></li>
                <li><a href="/faqs" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">FAQs</a></li>
                ...
                <li><a href="/contact" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">Contact Us</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li><a href="/privacy-policy" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">Privacy Policy</a></li>
                <li><a href="/terms-of-service" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">Terms of Service</a></li>
                <li><a href="/cookie-policy" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">Cookie Policy</a></li>
                <li><a href="/terms-and-conditions" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">Terms & Conditions</a></li>
                <li><a href="/disclaimer" className="text-gray-400 hover:text-emerald-400 transition-colors text-sm">Disclaimer</a></li>
              </ul>
            </div>

            {/* Contact Info */}
            <div className="space-y-4">
              <h4 className="text-lg font-semibold text-emerald-400">Get in Touch</h4>
              <ul className="space-y-3 text-sm text-gray-400">
                <li className="flex items-start gap-2">
                  ...
                  <span>support@nlistplanet.com</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-emerald-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
