            ...
            <div className="col-span-2">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 bg-gray-700 hover:bg-purple-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110"
                >
